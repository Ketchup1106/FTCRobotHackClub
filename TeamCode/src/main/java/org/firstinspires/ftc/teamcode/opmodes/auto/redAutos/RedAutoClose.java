...
public class RedAutoClose extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        follower.setStartingPose(new Pose(112, 135.5,  Math.toRadians(90)));
    ...
    public void buildPaths() {
        ...
        final Pose startPose = new Pose(112, 135.5,  Math.toRadians(90));
        final Pose shootPoseClose = new Pose(96, 96, Math.toRadians(0)); //Change Coordinates
        final Pose grabPose1 = new Pose(104, 84, Math.toRadians(0));
        final Pose grabbed1 = new Pose(121, 84, Math.toRadians(0));
        final Pose rampMid = new Pose(123, 74, Math.toRadians(300)); //EDIT
        final Pose ramp = new Pose(129, 70, Math.toRadians(0));
        final Pose grabPose2 = new Pose(104, 60, Math.toRadians(0));
        final Pose grabbed2 = new Pose(121, 60, Math.toRadians(0));
        final Pose grabPose3 = new Pose(104, 36, Math.toRadians(0));
        final Pose grabbed3 = new Pose(121, 36, Math.toRadians(0));
        final Pose parkPose = new Pose(120, 72,   Math.toRadians(0));
