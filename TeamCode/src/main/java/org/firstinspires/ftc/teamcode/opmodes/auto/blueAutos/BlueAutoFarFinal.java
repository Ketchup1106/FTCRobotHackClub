...
//
//@Autonomous(name = "blue far final final", group = "Autonomous")
//public class BlueAutoFarFinal extends LinearOpMode {
//
//    Follower follower;
...
//            goalAngle = Math.abs(Math.atan2(disX, disY)); //simple inverse trig with compensation for robot's extra 90 degrees
//            if(step != 17){
...
//
//        final Pose shootPose = new Pose(57, 13,  Math.toRadians(97.5));
//
//
