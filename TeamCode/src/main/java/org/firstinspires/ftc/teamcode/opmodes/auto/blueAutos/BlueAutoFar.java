...
public class BlueAutoFar extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        follower.setStartingPose(new Pose(55.5, 7.5,  Math.toRadians(90)));
    ...
    public void buildPaths() {
        ...
        final Pose startPose = new Pose(55.5, 7.5,  Math.toRadians(90));
        final Pose shootMid = new Pose(60, 7.5,  Math.toRadians(90));
