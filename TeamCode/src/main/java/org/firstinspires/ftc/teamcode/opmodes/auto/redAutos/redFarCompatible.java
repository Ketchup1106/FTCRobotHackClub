...
@Autonomous(name = "Red Far Compatible", group = "Autonomous", preselectTeleOp = "FAR Blue Teleop")

public class redFarCompatible extends OpMode {
...
//                    testDexer.spinToNext(intakeSide);
            ...
            ///////////////////////////////////////////////////////////////////
            case 8:
                if (!follower.isBusy() && MathFunctions.roughlyEquals(spinPos, testDexer.backThirdIntakePos, 50)) {
...
// final Pose shootMid = new Pose(84, 8, Math.toRadians(180));
        ...
        final Pose shootMid2 = new Pose(94, 34, Math.toRadians(180));
        final Pose shootPoseFar = new Pose(84, 16, Math.toRadians(180));

        final Pose grabPose1 = new Pose(98, 34, Math.toRadians(180));
        final Pose grabPose1One = new Pose(105, 34, Math.toRadians(180));
        final Pose grabPose1Two = new Pose(113, 34, Math.toRadians(180));
        final Pose grabbed1 = new Pose(124, 34, Math.toRadians(180));

        final Pose rampMid = new Pose(122, 67, Math.toRadians(225));
        final Pose ramp = new Pose(129, 70, Math.toRadians(180));

        final Pose grabPose2 = new Pose(132, 21, Math.toRadians(180));
        final Pose grabPose2One = new Pose(132, 19, Math.toRadians(180));
        final Pose grabPose2Two = new Pose(132, 12, Math.toRadians(180));
        final Pose grabbed2 = new Pose(132, 11, Math.toRadians(180));

        final Pose grabPose3 = new Pose(134, 20, Math.toRadians(160));
        final Pose grabPose3One = new Pose(134, 20, Math.toRadians(160));
        final Pose grabPose3Two = new Pose(134, 20, Math.toRadians(160));
        final Pose grabbed3 = new Pose(134, 20, Math.toRadians(180));
