...
public class RedAutoFar extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        follower.setStartingPose(new Pose(88.5, 7.5,  Math.toRadians(90)));
    ...
    public void buildPaths() {
        ...
        final Pose startPose = new Pose(88.5, 7.5,  Math.toRadians(90));
        final Pose shootMid = new Pose(88.5, 7.5,  Math.toRadians(90));
        final Pose shootMid2 = new Pose(96, 48,  Math.toRadians(180)); //edit
        final Pose shootPoseFar = new Pose(84, 16, Math.toRadians(180)); //Change Coordinates
        final Pose grabPose1 = new Pose(104, 60, Math.toRadians(180));
        final Pose grabbed1 = new Pose(121, 60, Math.toRadians(180));
        final Pose rampMid = new Pose(123, 67, Math.toRadians(225)); //edit
        final Pose ramp = new Pose(129, 70, Math.toRadians(180));
        final Pose grabPose2 = new Pose(104, 36, Math.toRadians(180));
