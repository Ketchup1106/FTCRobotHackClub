...
@Autonomous(name = "Red close final", group = "Autonomous")
public class RedAutoCloseFinal extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        follower.setStartingPose(new Pose(111, 135,  Math.toRadians(180)));
...
//            }
    ...
    public void buildPaths() {
        ...
        final Pose startPose = new Pose(111, 135,  Math.toRadians(180));

        final Pose shootPose = new Pose(96, 98,  Math.toRadians(43));


//        final Pose midPose = new Pose(108, 13,  Math.toRadians(90));


        final Pose parkPose = new Pose(125, 105,   Math.toRadians(90));
